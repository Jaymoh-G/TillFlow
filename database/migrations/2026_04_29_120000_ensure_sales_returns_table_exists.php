...
/**
 * Recreates sales_returns when the migration batch was recorded but the table
 * was never created (e.g. DB reset, wrong database, or manual DB copy).
 */
return new class extends Migration
{
    ...
    {
        // Do not drop — table may have been created by an earlier migration name.
    }
};
