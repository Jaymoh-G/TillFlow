    ...
    () => [
      {
        ...
        body: (row) => (
          <Link to={`/admin/delivery-notes/${row.apiId}`} className="fw-medium">
            {row.deliveryNoteNo}
          </Link>
        )
      },
      {
        ...
        body: (row) =>
          row.invoiceId ? (
            <Link to={`/admin/invoices/${row.invoiceId}`}>{row.invoiceRef || `Invoice #${row.invoiceId}`}</Link>
          ) : (
            row.invoiceRef || "—"
          )
      },
        ...
        body: (row) => (
          <div className="text-end text-nowrap">
            <Dropdown align="end">
              ...
              <Dropdown.Menu>
                <Dropdown.Item as={Link} to={`/admin/delivery-notes/${row.apiId}`}>
                ...
                <Dropdown.Item
                  as={Link}
                  to={`/admin/delivery-notes/${row.apiId}?emailCustomer=1`}
                ...
                <Dropdown.Item
                  as={Link}
                  to={`/admin/delivery-notes/${row.apiId}?cancel=1`}
