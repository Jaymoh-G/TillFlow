...
const DeliveryNotePrintDocument = forwardRef(function DeliveryNotePrintDocument(
  ...
  const hasAnyUom = Array.isArray(lineRows)
    ? lineRows.some((r) => String(r?.uom ?? "").trim() !== "")
    : false;
  return (
      ...
      <div className="card-body pt-2 pb-3 px-3 bg-white" style={{ overflowX: "hidden" }}>
        ...
        <div className="row g-0 mb-2">
          ...
          <div className="col-md-6 text-md-end">
            <p className="text-dark mb-2 fw-semibold">Deliver to</p>
        ...
        <div className="table-responsive mb-3" style={{ overflowX: "hidden" }}>
          <table className="table quotation-view-line-items mb-0 bg-white w-100" style={{ tableLayout: "fixed" }}>
            ...
            <tfoot>
              <tr>
                <td colSpan={hasAnyUom ? 2 : 1} className="bg-transparent border-bottom-0" />
                <td className="text-end fw-bold border-bottom-0">Total items</td>
                <td className="text-end fw-bold border-bottom-0">{totals.totalItems}</td>
              </tr>
              <tr>
                <td colSpan={hasAnyUom ? 2 : 1} className="bg-transparent border-bottom-0" />
        ...
        <div className="mb-3 border-bottom pb-3">
          <p className="mb-2 text-dark">Name ________________________________</p>
          <p className="mb-2 text-dark">Items delivered in good condition ________________________________</p>
          <p className="mb-0 text-dark">Sign ________________________________  Date ________________________________</p>
        </div>
...
export default memo(DeliveryNotePrintDocument);
