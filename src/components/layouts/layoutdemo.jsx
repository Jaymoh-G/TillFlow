...
import { customer11, customer12, customer13, customer14, customer15, customer16, customer17, customer18, product1, product11, product12, product13, product14, product15, product16, product3, product4, product5 } from "../../utils/imagepath";
import CommonDateRangePicker from "../date-range-picker/common-date-range-picker";

import CommonFooter from "../footer/commonFooter";
import DashboardRecentTransactionsWidget from "../../feature-module/dashboard/components/DashboardRecentTransactionsWidget.jsx";
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        ...
        <div className="row">
          {/* Top Selling */}
          <div className="col-xxl-6 col-md-6 d-flex">
            <div className="card flex-fill">
        ...
        <div className="row">
          ...
          {/* Recent Transactions */}
          <div className="col-xl-6 col-sm-12 col-12 d-flex">
            <DashboardRecentTransactionsWidget titleIconClassName="ms-2" />
          </div>
          {/* /Recent Transactions */}
        </div>
        <div className="row">
