export const all_routes = {
  ...
  tillflowAdminAppearance: "/admin/settings/appearance",
  tillflowAdminSocialAuth: "/admin/settings/social-authentication",
  tillflowAdminSecurity: "/admin/settings/security",
  tillflowAdminNotification: "/admin/settings/notifications",
  tillflowAdminConnectedApps: "/admin/settings/connected-apps",
  tillflowAdminInvoiceSettings: "/admin/settings/invoice",
  tillflowAdminPrinterSettings: "/admin/settings/printer",
  tillflowAdminPosSettings: "/admin/settings/pos",
  tillflowAdminSignatures: "/admin/settings/signatures",
  tillflowAdminCustomFields: "/admin/settings/custom-fields",
  tillflowAdminEmailSettings: "/admin/settings/email",
  tillflowAdminEmailTemplates: "/admin/settings/email-templates",
  tillflowAdminSmsGateway: "/admin/settings/sms-gateway",
  tillflowAdminSmsTemplates: "/admin/settings/sms-templates",
  tillflowAdminOtpSettings: "/admin/settings/otp",
  tillflowAdminGdprSettings: "/admin/settings/gdpr",
  tillflowAdminPaymentGateway: "/admin/settings/payment-gateway",
  tillflowAdminBankAccounts: "/admin/settings/bank-accounts",
  tillflowAdminTaxRates: "/admin/settings/tax-rates",
  tillflowAdminCurrencySettings: "/admin/settings/currencies",
  tillflowAdminStorageSettings: "/admin/settings/storage",
  tillflowAdminBanIpAddress: "/admin/settings/ban-ip",
  tillflowAdminPurchases: "/admin/purchases",
  tillflowAdminPurchaseOrders: "/admin/purchase-orders",
  tillflowAdminPurchaseReturns: "/admin/purchase-returns",
  ...
  companies: "/companies",
  subscription: "/platform-owner/subscribers",
