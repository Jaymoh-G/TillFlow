export const all_routes = {
  ...
  tillflowAdminSecurity: "/tillflow/admin/settings/security",
  tillflowAdminNotification: "/tillflow/admin/settings/notifications",
  tillflowAdminConnectedApps: "/tillflow/admin/settings/connected-apps",
  tillflowAdminInvoiceSettings: "/tillflow/admin/settings/invoice",
  tillflowAdminPrinterSettings: "/tillflow/admin/settings/printer",
  tillflowAdminPosSettings: "/tillflow/admin/settings/pos",
  tillflowAdminSignatures: "/tillflow/admin/settings/signatures",
  tillflowAdminCustomFields: "/tillflow/admin/settings/custom-fields",
  tillflowAdminEmailSettings: "/tillflow/admin/settings/email",
  tillflowAdminEmailTemplates: "/tillflow/admin/settings/email-templates",
  tillflowAdminSmsGateway: "/tillflow/admin/settings/sms-gateway",
  tillflowAdminSmsTemplates: "/tillflow/admin/settings/sms-templates",
  tillflowAdminOtpSettings: "/tillflow/admin/settings/otp",
  tillflowAdminGdprSettings: "/tillflow/admin/settings/gdpr",
  tillflowAdminPaymentGateway: "/tillflow/admin/settings/payment-gateway",
  tillflowAdminBankAccounts: "/tillflow/admin/settings/bank-accounts",
  tillflowAdminTaxRates: "/tillflow/admin/settings/tax-rates",
  tillflowAdminCurrencySettings: "/tillflow/admin/settings/currencies",
  tillflowAdminStorageSettings: "/tillflow/admin/settings/storage",
  tillflowAdminBanIpAddress: "/tillflow/admin/settings/ban-ip",
  tillflowAdminPurchases: "/tillflow/admin/purchases",
  tillflowAdminPurchaseOrders: "/tillflow/admin/purchase-orders",
  tillflowAdminPurchaseReturns: "/tillflow/admin/purchase-returns",
  ...
  companies: "/companies",
  subscription: "/platform-owner/subscription",
